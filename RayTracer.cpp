...
void initialize()
{
    ...
    Sphere *sphere1 = new Sphere(Vector(6, 6, -40), 2.0, Color::RED);
    Sphere *sphere2 = new Sphere(Vector(-3, 0, -50), 8.0, Color::BLUE);
    Sphere *sphere3 = new Sphere(Vector(5, -5, -80), 3.0, Color::GREEN);
